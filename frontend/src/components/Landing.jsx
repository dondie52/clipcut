 ...
 * @description Public landing page at `/` — "Kalahari Manifesto" aesthetic.
 *   Editorial/brutalist type-driven hero. Asymmetric composition on desktop,
 *   type hierarchy carries the mobile view. Spline Sans weight contrast
 *   (800 vs 300) paired with Instrument Serif italic for accent words.
 *   Scope: nav + hero + three manifesto blocks + CTA. No features grid,
 *   no testimonials (see NO_SLOP.md §7).
 */
...
const Landing = () => {
  ...
  useEffect(() => {
    const styleId = "lp-landing-styles";
  ...
  return (
    <div className="lp-root">
      <nav className="lp-nav" aria-label="Primary">
        <span className="lp-wordmark" aria-label="ClipCut">
          Clip<span className="lp-wordmark-accent">Cut</span>
          <span className="lp-wordmark-mark">v0.1 · BW</span>
        </span>
      ...
      <main className="lp-hero">
        <section className="lp-head" aria-labelledby="lp-headline">
          <span className="lp-section-mark">
            § 01 · A public declaration
          </span>

          <h1 id="lp-headline" className="lp-headline">
            <span className="lp-headline-word">Make</span>{" "}
            <span className="lp-headline-word">video.</span>{" "}
            <span className="lp-headline-word lp-serif">In&nbsp;your</span>{" "}
            <span className="lp-headline-word lp-serif">browser.</span>{" "}
            <span className="lp-headline-word lp-headline-light">No&nbsp;tax.</span>{" "}
            <span className="lp-headline-word lp-headline-light">No&nbsp;excuses.</span>
          </h1>

          <p className="lp-subhead">
            ClipCut is an{" "}
            <span className="lp-subhead-em">open-source video editor</span>{" "}
            built in Gaborone for creators across Botswana and the wider
            African diaspora. Cut, caption, and export — without paying a
            subscription, watermarking your work, or needing a MacBook.
          </p>
          ...
          <div className="lp-cta-row">
            ...
            <span className="lp-cta-microcopy">
              Two minutes. No card. Works in any modern browser.
            </span>
          </div>
        </section>

        <aside className="lp-rail" aria-label="Project metadata">
          <span className="lp-rail-status">
            <span className="lp-rail-status-dot" aria-hidden="true" />
            Live · 0.1.0
          </span>
          <div className="lp-rail-row">
            <span className="lp-rail-label">Origin</span>
            <span className="lp-rail-value">Gaborone, Botswana<br />24.6282° S · 25.9231° E</span>
          </div>
          <div className="lp-rail-row">
            <span className="lp-rail-label">License</span>
            <span className="lp-rail-value">MIT — free forever</span>
          </div>
          <div className="lp-rail-row">
            <span className="lp-rail-label">Runtime</span>
            <span className="lp-rail-value">Browser · Linux · Windows</span>
          </div>
          <div className="lp-rail-row">
            <span className="lp-rail-label">Price</span>
            <span className="lp-rail-value" style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 14 }}>
              P 0.00 / forever
            </span>
          </div>
        </aside>
      ...
      <section className="lp-manifesto" aria-label="Principles">
        <div className="lp-manifesto-stripe" role="presentation" aria-hidden="true">
          <span /><span /><span /><span /><span />
        </div>

        <div className="lp-blocks">
          <article className="lp-block">
            <span className="lp-block-index">
              <span className="lp-block-index-dot" aria-hidden="true" />
              § 01 — Zero cost
            </span>
            <h2 className="lp-block-title">
              Not a trial.{" "}
              <span className="lp-block-title-em">Not&nbsp;freemium.</span>
            </h2>
            <p className="lp-block-body">
              P0 forever. Run it in your browser, clone the source, or fork it
              — your choice. No paywalls, no upgrade prompts, no feature gates.
            </p>
          </article>
          ...
          <article className="lp-block">
            ...
            <h2 className="lp-block-title">
              Your video is{" "}
              <span className="lp-block-title-em">your&nbsp;video.</span>
            </h2>
            <p className="lp-block-body">
              Nothing embedded. Nothing branded. Nothing to remove. Export at
              1080p and ship to TikTok, YouTube, or a WhatsApp group unchanged.
            </p>
          </article>
          ...
          <article className="lp-block">
            ...
            <h2 className="lp-block-title">
              Built for{" "}
              <span className="lp-block-title-em">low-bandwidth</span> reality.
            </h2>
            <p className="lp-block-body">
              Designed in Gaborone for creators on 4G, coffee-shop WiFi, and
              everything in between. Works offline after first load. No macOS
              required.
            </p>
          </article>
        </div>
      ...
      <footer className="lp-sig">
        <span className="lp-sig-mark">
          ClipCut · 2026 · MIT License · Made in Gaborone
        </span>
        <span className="lp-sig-stamp" aria-hidden="true">
          ClipCut.
        </span>
      </footer>
