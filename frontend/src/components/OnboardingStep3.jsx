 ...
 * @description Onboarding Step 3 — Preferences & launch
 */
...
const OnboardingStep3 = ({ onComplete, onSkip }) => {
  ...
  return (
    <div className="ob3-root">
      ...
      <div className="ob3-glow" />

      <header className="ob3-header">
        <div className="ob3-brand">
          <div className="ob3-logo-icon">
            <span className="material-symbols-outlined" style={{ fontSize: "18px", color: "white", fontVariationSettings: "'FILL' 1" }}>movie</span>
            <span className="ob3-logo-badge material-symbols-outlined">content_cut</span>
          </div>
          <span className="ob3-logo-name">ClipCut</span>
        </div>
        <div className="ob3-progress">
          <div className="ob3-dots">
            <div className="ob3-dot done" />
            <div className="ob3-dot done" />
            <div className="ob3-dot active" />
          </div>
      ...
      <main className="ob3-main">
        <div className="ob3-container">
          <div className="ob3-heading">
            ...
            <h1 className="ob3-title">Fine-tune your workspace</h1>
            <p className="ob3-subtitle">Set your defaults — adjust anytime in Settings.</p>
          </div>
            ...
            <div className="ob3-section">
              ...
              <div className="ob3-res-stack" role="radiogroup" aria-label="Default export resolution">
                {resolutions.map((r) => {
                  ...
                  return (
                    <div key={r.id} className={`ob3-res-card ${sel ? "selected" : ""}`} role="radio" aria-checked={sel} tabIndex={0}
                      ...
                      <div className="ob3-radio"><div className="ob3-radio-dot" /></div>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="ob3-toggles">
                {notifOptions.map((n) => (
                  <div key={n.key} className="ob3-toggle-row">
                    ...
                    <button type="button" role="switch" aria-checked={notifications[n.key]} aria-label={n.label}
                      className={`ob3-switch ${notifications[n.key] ? "on" : ""}`} onClick={() => toggleNotif(n.key)}>
            ...
            <div className="ob3-autosave-card">
              <div className="ob3-autosave-left">
                ...
                <div className="ob3-toggle-info">
                  ...
                  <div className="ob3-toggle-desc">Back up your work automatically as you edit</div>
                </div>
              </div>
              <button type="button" role="switch" aria-checked={autoSave} aria-label="Auto-save projects"
          ...
          <div className="ob3-actions">
            <button className="ob3-btn-launch" onClick={() => { trackEvent(analyticsEvents.onboardingComplete, { step: "3" }); onComplete?.(); }}>
            ...
            <a href="#" className="ob3-btn-ghost" onClick={(e) => { e.preventDefault(); trackEvent(analyticsEvents.onboardingSkip, { step: "3" }); onSkip?.(); }}>Skip for now</a>
          </div>
        </div>
      </main>
