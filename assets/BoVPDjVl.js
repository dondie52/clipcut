import{u as te,r as s,j as e}from"./-P2Ya96f.js";import{u as ae,l as S,g as $,t as j,b as y}from"./fr5aj7dF.js";import{u as ie,l as re,d as se,a as oe,b as ne,s as le}from"./TQlpFJ0r.js";import{h as ce}from"./Et-wlZO3.js";import"./DZxFKcQQ.js";import"./B9CjrYEi.js";const T="clipcut-dashboard-advisor-dismissed",de=`
...
`,i=({i:r,s:n=20,c:l,fill:x=!1,style:c})=>e.jsx("span",{className:"material-symbols-outlined",style:{fontSize:n,color:l,fontVariationSettings:x?"'FILL' 1":"'FILL' 0",...c},children:r}),pe=[{id:"home",icon:"home",label:"Home",fill:!0},{id:"templates",icon:"dashboard",label:"Templates"},{id:"shorts",icon:"content_cut",label:"Long to Shorts"},{id:"divider"},{id:"settings",icon:"settings",label:"Settings"}];function E(r){if(!r)return"Never";const n=Date.now()-new Date(r).getTime(),l=Math.floor(n/6e4);if(l<1)return"Just now";if(l<60)return`${l}m ago`;const x=Math.floor(l/60);if(x<24)return`${x}h ago`;const c=Math.floor(x/24);return c<7?`${c}d ago`:c<30?`${Math.floor(c/7)}w ago`:new Date(r).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function xe(r){return r?`${new Date(r).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})} · ${E(r)}`:"Never"}function ge(){const r=new Date().getHours();return r<12?"Good morning":r<18?"Good afternoon":"Good evening"}function be(r){return r?new Date(r).toLocaleDateString("en-US",{month:"short",year:"numeric"}):"—"}const Y=s.memo(({user:r,activeNav:n,onNav:l,onNavigate:x,isOpen:c,onClose:u})=>{const f=r?.user_metadata?.full_name||r?.email?.split("@")[0]||"Creator",h=f.charAt(0).toUpperCase();return e.jsxs("aside",{className:`sidebar ${c?"sidebar-open":""}`,children:[u&&e.jsx("button",{className:"sidebar-close-btn",onClick:u,"aria-label":"Close menu",children:e.jsx(i,{i:"close",s:18})}),e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("div",{className:"sidebar-logo-icon",children:e.jsx(i,{i:"content_cut",s:16,c:"white"})}),e.jsx("span",{style:{fontSize:"16px",fontWeight:700},children:"ClipCut"})]}),e.jsxs("div",{className:"sidebar-user",children:[e.jsx("div",{className:"sidebar-avatar",children:h}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("p",{style:{fontSize:"12px",fontWeight:600,margin:0,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:f}),e.jsx("p",{style:{fontSize:"10px",color:"rgba(255,255,255,0.25)",margin:0},children:"Free Plan"})]})]}),e.jsx("nav",{className:"sidebar-nav",children:pe.map(d=>d.id==="divider"?e.jsx("div",{className:"nav-divider"},"div"):e.jsxs("button",{className:`nav-item ${n===d.id?"active":""}`,onClick:()=>{l(d.id),d.id==="shorts"?x("/long-to-shorts"):d.id==="settings"&&x("/settings")},children:[e.jsx(i,{i:d.icon,s:20,fill:d.fill&&n===d.id}),e.jsx("span",{style:{flex:1},children:d.label})]},d.id))}),e.jsx("div",{className:"sidebar-footer",children:"v0.1.0 beta"})]})});Y.displayName="Sidebar";const ye=()=>{const r=te(),{user:n}=ae(),l=ie(),x=s.useRef(null),[c,u]=s.useState("home"),[f,h]=s.useState(!1),[d,O]=s.useState(""),[p,w]=s.useState([]),[m,P]=s.useState(!0),[k,L]=s.useState(null),[W,N]=s.useState(null),[A,M]=s.useState(""),[B,G]=s.useState(()=>{try{return typeof window<"u"&&localStorage.getItem(T)==="1"}catch{return!1}}),Q=s.useCallback(()=>{try{localStorage.setItem(T,"1")}catch{}G(!0)},[]),V=n?.user_metadata?.full_name||n?.email?.split("@")[0]||"Creator",I=s.useMemo(()=>p.length===0?null:[...p].sort((a,o)=>new Date(o.savedAt||0)-new Date(a.savedAt||0))[0]?.savedAt,[p]),g=s.useCallback(async()=>{P(!0),L(null);try{const a=(await re(n?.id)).map(o=>({id:o.id,name:o.name,thumbnail:o.thumbnail_url,duration:o.duration_seconds>0?`${Math.floor(o.duration_seconds/60)}:${String(Math.floor(o.duration_seconds%60)).padStart(2,"0")}`:"0:00",resolution:o.resolution||"1080p",savedAt:o.updated_at||o.created_at,isCloud:!o._source||o._source!=="localStorage"}));w(a)}catch(t){S.error("Failed to load projects",{error:t}),L($(t,"project")),w([])}finally{P(!1)}},[n?.id]);s.useEffect(()=>{g();const t=()=>g();window.addEventListener("focus",t);const a=()=>g();return window.addEventListener("storage",a),()=>{window.removeEventListener("focus",t),window.removeEventListener("storage",a)}},[g]);const z=s.useCallback(()=>{j(y.dashboardNewProjectClick),x.current?.click()},[]),H=s.useCallback(t=>{const a=Array.from(t.target.files);a.length>0&&(j(y.dashboardFileImport,{fileCount:a.length}),r("/editor",{state:{filesToImport:a}})),t.target.value=""},[r]),U=s.useCallback(t=>{j(y.dashboardProjectOpen,{projectId:t.id}),r("/editor",{state:{projectId:t.id,projectName:t.name}})},[r]),F=s.useCallback(async(t,a)=>{if(t.stopPropagation(),window.confirm("Are you sure you want to delete this project?"))try{await se(a,n?.id),j(y.dashboardProjectDelete,{projectId:a}),w(o=>o.filter(v=>v.id!==a))}catch(o){S.error("Failed to delete project",{error:o,projectId:a}),alert($(o,"project"))}},[n?.id]),q=s.useCallback((t,a)=>{t.stopPropagation(),N(a.id),M(a.name)},[]),R=s.useCallback(async t=>{const a=A.trim();if(!a||a===p.find(o=>o.id===t)?.name){N(null);return}try{await oe(t,n?.id,{name:a}),w(o=>o.map(v=>v.id===t?{...v,name:a}:v))}catch(o){S.error("Failed to rename project",{error:o})}N(null)},[A,p,n?.id]),[b,D]=s.useState(null),J=s.useCallback((t,a)=>{t.preventDefault(),t.stopPropagation(),D({x:t.clientX,y:t.clientY,project:a})},[]),C=s.useCallback(()=>D(null),[]);s.useEffect(()=>{if(!b)return;const t=()=>D(null);return window.addEventListener("click",t),window.addEventListener("contextmenu",t),()=>{window.removeEventListener("click",t),window.removeEventListener("contextmenu",t)}},[b]);const K=s.useCallback(async t=>{C();try{const a=await ne(t.id,n?.id);if(!a)return;await le(n?.id,{name:`${t.name} (copy)`,clips:a.project_data?.clips||[],duration:a.duration_seconds||0,resolution:a.resolution||"1080p"})&&g()}catch(a){S.error("Failed to duplicate project",{error:a})}},[n?.id,C,g]),X=ce(d),_=p.filter(t=>t.name.toLowerCase().includes(X.toLowerCase())),Z=!m&&_.length>0,ee=!m&&!k&&_.length===0;return e.jsxs("div",{className:"dash-root",children:[e.jsx("style",{children:de}),e.jsx("input",{ref:x,type:"file",accept:"video/*,audio/*,image/*",multiple:!0,style:{display:"none"},onChange:H}),e.jsx("div",{className:`sidebar-overlay ${f?"visible":""}`,onClick:()=>h(!1)}),e.jsx(Y,{user:n,activeNav:c,onNav:t=>{u(t),l&&h(!1)},onNavigate:r,isOpen:f,onClose:l?()=>h(!1):void 0}),e.jsxs("div",{className:"dash-content",children:[e.jsxs("header",{className:"top-bar",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[e.jsx("button",{className:"hamburger-btn",onClick:()=>h(t=>!t),"aria-label":"Open menu",children:e.jsx(i,{i:"menu",s:20})}),e.jsxs("div",{children:[e.jsxs("h1",{children:[ge(),", ",V]}),e.jsx("p",{className:"top-bar-sub",children:"Workspace overview"})]})]}),e.jsxs("div",{className:"top-bar-actions",children:[e.jsx("button",{className:"icon-btn",onClick:g,title:"Refresh projects",children:e.jsx(i,{i:"refresh",s:18})}),e.jsx("button",{className:"icon-btn",onClick:()=>r("/settings"),title:"Settings",children:e.jsx(i,{i:"settings",s:18})})]})]}),e.jsx("div",{className:"dash-body",children:e.jsxs("div",{className:`dash-layout ${!l&&B?"dash-layout--single":""}`,children:[e.jsxs("div",{className:"dash-main",children:[e.jsxs("div",{className:"stats-row",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"folder",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:m?"—":p.length}),e.jsx("span",{className:"stat-label",children:"Projects"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"schedule",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:m?"—":E(I)}),e.jsx("span",{className:"stat-label",children:"Last edited"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"calendar_month",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:be(n?.created_at)}),e.jsx("span",{className:"stat-label",children:"Member since"})]})]})]}),e.jsx("div",{className:"section-label",children:"Quick Actions"}),e.jsxs("div",{className:"quick-actions",children:[e.jsxs("button",{className:"quick-action quick-action--primary",onClick:z,children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"add",s:20,c:"white"})}),e.jsx("span",{children:"New Project"})]}),e.jsxs("button",{className:"quick-action",onClick:()=>{j(y.dashboardToolSelect,{tool:"long_to_shorts"}),r("/long-to-shorts")},children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"content_cut",s:18,c:"#75AADB"})}),e.jsx("span",{children:"Long to Shorts"}),e.jsx("span",{className:"qa-badge",children:"AI"})]})]}),e.jsxs("div",{className:"projects-header",children:[e.jsx("div",{className:"section-label",style:{margin:0},children:"Your Projects"}),p.length>0&&e.jsxs("div",{className:"proj-search",children:[e.jsx(i,{i:"search"}),e.jsx("input",{type:"text",placeholder:"Search...","aria-label":"Search projects",value:d,onChange:t=>O(t.target.value)})]})]}),k&&e.jsxs("div",{className:"error-banner",children:[e.jsx(i,{i:"cloud_off",s:18,c:"#ef4444"}),e.jsx("span",{children:k}),e.jsx("button",{className:"error-retry",onClick:g,children:"Retry"})]}),m&&!k&&e.jsx("div",{className:"projects-grid",children:[1,2,3,4,5,6].map(t=>e.jsxs("div",{className:"project-card",style:{pointerEvents:"none"},children:[e.jsx("div",{className:"project-thumb skel"}),e.jsxs("div",{className:"project-info",children:[e.jsx("div",{style:{width:"65%",height:"12px",borderRadius:"4px",background:"#1a2332",marginBottom:"5px"}}),e.jsx("div",{style:{width:"35%",height:"10px",borderRadius:"4px",background:"#151b24"}})]})]},t))}),Z&&e.jsx("div",{className:"projects-grid",children:_.map(t=>e.jsxs("div",{className:"project-card",onClick:()=>U(t),onContextMenu:a=>J(a,t),children:[e.jsxs("div",{className:"project-thumb",children:[t.thumbnail?e.jsx("img",{src:t.thumbnail,alt:t.name,onError:a=>{a.target.style.display="none",a.target.nextSibling.style.display="flex"}}):null,e.jsx("div",{style:{display:t.thumbnail?"none":"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",position:"absolute",inset:0,background:"#111820"},children:e.jsx(i,{i:"movie",s:32,c:"rgba(255,255,255,0.1)"})}),e.jsx("button",{className:"del-btn",onClick:a=>F(a,t.id),"aria-label":`Delete project ${t.name}`,title:"Delete project",children:e.jsx(i,{i:"delete",s:14,c:"white"})})]}),e.jsxs("div",{className:"project-info",children:[W===t.id?e.jsx("input",{autoFocus:!0,value:A,onChange:a=>M(a.target.value),onBlur:()=>R(t.id),onKeyDown:a=>{a.key==="Enter"&&R(t.id),a.key==="Escape"&&N(null)},onClick:a=>a.stopPropagation(),style:{background:"rgba(117,170,219,0.1)",border:"1px solid rgba(117,170,219,0.3)",borderRadius:"4px",padding:"2px 6px",color:"white",fontSize:"13px",fontWeight:600,fontFamily:"inherit",width:"100%",outline:"none"}}):e.jsx("p",{className:"name",onDoubleClick:a=>q(a,t),title:"Double-click to rename",children:t.name}),e.jsxs("p",{className:"meta",children:[t.resolution," · ",xe(t.savedAt)]})]})]},t.id))}),b&&e.jsxs("div",{className:"ctx-menu",style:{left:b.x,top:b.y},children:[e.jsxs("button",{className:"ctx-menu-item",onClick:()=>{q({stopPropagation:()=>{}},b.project),C()},children:[e.jsx(i,{i:"edit",s:14})," Rename"]}),e.jsxs("button",{className:"ctx-menu-item",onClick:()=>K(b.project),children:[e.jsx(i,{i:"content_copy",s:14})," Duplicate"]}),e.jsx("div",{className:"ctx-menu-sep"}),e.jsxs("button",{className:"ctx-menu-item ctx-menu-item--danger",onClick:t=>{F(t,b.project.id),C()},children:[e.jsx(i,{i:"delete",s:14})," Delete"]})]}),ee&&e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:e.jsx(i,{i:"movie_edit",s:26,c:"rgba(117,170,219,0.5)"})}),e.jsx("h3",{children:"Your workspace is ready"}),e.jsx("p",{children:"Import a video, image, or audio file to create your first project and start editing."}),e.jsxs("div",{className:"empty-actions",children:[e.jsxs("button",{className:"empty-btn empty-btn--primary",onClick:z,children:[e.jsx(i,{i:"add",s:16,c:"#0a0a0a"}),"Import Media"]}),e.jsxs("button",{className:"empty-btn empty-btn--ghost",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:14}),"Long to Shorts"]})]}),e.jsx("p",{className:"empty-hint",children:"Supports MP4, WebM, MP3, WAV, PNG, JPG and more"})]})]}),!l&&!B&&e.jsxs("aside",{className:"advisor-panel",children:[e.jsxs("div",{className:"advisor-label-row",children:[e.jsxs("div",{className:"advisor-label",children:[e.jsx(i,{i:"assistant",s:14,c:"rgba(255,255,255,0.25)"}),"Advisor"]}),e.jsx("button",{type:"button",className:"advisor-dismiss",onClick:Q,"aria-label":"Dismiss advisor panel",title:"Hide advisor",children:e.jsx(i,{i:"close",s:18})})]}),e.jsxs("div",{className:"advisor-item advisor-item--warning",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"shield",s:16,c:"#f59e0b"}),e.jsx("h4",{children:"Account Security"})]}),e.jsx("p",{children:"Strengthen your account by reviewing your security settings."}),e.jsxs("button",{className:"advisor-action advisor-action--warning",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#f59e0b"}),"Review Settings"]})]}),p.length===0&&!m?e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"rocket_launch",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Getting Started"})]}),e.jsxs("ul",{className:"advisor-checklist",children:[e.jsxs("li",{className:"done",children:[e.jsx(i,{i:"check_circle",s:14,fill:!0}),e.jsx("span",{children:"Create account"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Import your first media file"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Edit and export a project"})]})]})]}):p.length>0?e.jsxs("div",{className:"advisor-item advisor-item--success",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"check_circle",s:16,c:"#22c55e"}),e.jsx("h4",{children:"Workspace Active"})]}),e.jsxs("p",{children:[p.length," project",p.length!==1?"s":""," in your workspace. Last edited ",E(I),"."]})]}):null,e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"auto_awesome",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Long to Shorts"})]}),e.jsx("p",{children:"Convert landscape videos to vertical format with AI-powered speaker tracking and smart reframing."}),e.jsxs("button",{className:"advisor-action advisor-action--info",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#75AADB"}),"Try it"]})]})]})]})})]}),l&&e.jsxs("nav",{className:"mobile-bottom-nav",children:[e.jsxs("button",{className:c==="home"?"active":"",onClick:()=>u("home"),children:[e.jsx(i,{i:"home",s:22,fill:c==="home"}),e.jsx("span",{children:"Home"})]}),e.jsxs("button",{onClick:z,children:[e.jsx(i,{i:"add_circle",s:22,c:"#75AADB"}),e.jsx("span",{children:"New"})]}),e.jsxs("button",{className:c==="shorts"?"active":"",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:22}),e.jsx("span",{children:"Shorts"})]}),e.jsxs("button",{className:c==="settings"?"active":"",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"settings",s:22}),e.jsx("span",{children:"Settings"})]})]}),e.jsxs("div",{className:"bw-stripe",role:"presentation",children:[e.jsx("div",{style:{background:"#75AADB"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#000"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#75AADB"}})]})]})};export{ye as default};
