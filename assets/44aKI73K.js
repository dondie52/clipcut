import{u as J,r as o,j as e}from"./-P2Ya96f.js";import{u as K,l as C,g as I,t as v,b as j}from"./FgVWUtmG.js";import{u as X,l as Z,d as ee,a as ae}from"./B2ooi-rz.js";import{h as te}from"./DuArS60f.js";import"./DZxFKcQQ.js";import"./B9CjrYEi.js";const M="clipcut-dashboard-advisor-dismissed",ie=`
...
`,i=({i:r,s:n=20,c:l,fill:x=!1,style:d})=>e.jsx("span",{className:"material-symbols-outlined",style:{fontSize:n,color:l,fontVariationSettings:x?"'FILL' 1":"'FILL' 0",...d},children:r}),re=[{id:"home",icon:"home",label:"Home",fill:!0},{id:"templates",icon:"dashboard",label:"Templates"},{id:"shorts",icon:"content_cut",label:"Long to Shorts"},{id:"divider"},{id:"settings",icon:"settings",label:"Settings"}];function z(r){if(!r)return"Never";const n=Date.now()-new Date(r).getTime(),l=Math.floor(n/6e4);if(l<1)return"Just now";if(l<60)return`${l}m ago`;const x=Math.floor(l/60);if(x<24)return`${x}h ago`;const d=Math.floor(x/24);return d<7?`${d}d ago`:d<30?`${Math.floor(d/7)}w ago`:new Date(r).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function se(){const r=new Date().getHours();return r<12?"Good morning":r<18?"Good afternoon":"Good evening"}function oe(r){return r?new Date(r).toLocaleDateString("en-US",{month:"short",year:"numeric"}):"—"}const q=o.memo(({user:r,activeNav:n,onNav:l,onNavigate:x,isOpen:d,onClose:m})=>{const u=r?.user_metadata?.full_name||r?.email?.split("@")[0]||"Creator",g=u.charAt(0).toUpperCase();return e.jsxs("aside",{className:`sidebar ${d?"sidebar-open":""}`,children:[m&&e.jsx("button",{className:"sidebar-close-btn",onClick:m,"aria-label":"Close menu",children:e.jsx(i,{i:"close",s:18})}),e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("div",{className:"sidebar-logo-icon",children:e.jsx(i,{i:"content_cut",s:16,c:"white"})}),e.jsx("span",{style:{fontSize:"16px",fontWeight:700},children:"ClipCut"})]}),e.jsxs("div",{className:"sidebar-user",children:[e.jsx("div",{className:"sidebar-avatar",children:g}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("p",{style:{fontSize:"12px",fontWeight:600,margin:0,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:u}),e.jsx("p",{style:{fontSize:"10px",color:"rgba(255,255,255,0.25)",margin:0},children:"Free Plan"})]})]}),e.jsx("nav",{className:"sidebar-nav",children:re.map(c=>c.id==="divider"?e.jsx("div",{className:"nav-divider"},"div"):e.jsxs("button",{className:`nav-item ${n===c.id?"active":""}`,onClick:()=>{l(c.id),c.id==="shorts"?x("/long-to-shorts"):c.id==="settings"&&x("/settings")},children:[e.jsx(i,{i:c.icon,s:20,fill:c.fill&&n===c.id}),e.jsx("span",{style:{flex:1},children:c.label})]},c.id))}),e.jsx("div",{className:"sidebar-footer",children:"v0.1.0 beta"})]})});q.displayName="Sidebar";const ge=()=>{const r=J(),{user:n}=K(),l=X(),x=o.useRef(null),[d,m]=o.useState("home"),[u,g]=o.useState(!1),[c,F]=o.useState(""),[p,y]=o.useState([]),[b,D]=o.useState(!0),[w,_]=o.useState(null),[R,k]=o.useState(null),[N,E]=o.useState(""),[P,T]=o.useState(()=>{try{return typeof window<"u"&&localStorage.getItem(M)==="1"}catch{return!1}}),$=o.useCallback(()=>{try{localStorage.setItem(M,"1")}catch{}T(!0)},[]),O=n?.user_metadata?.full_name||n?.email?.split("@")[0]||"Creator",B=o.useMemo(()=>p.length===0?null:[...p].sort((t,s)=>new Date(s.savedAt||0)-new Date(t.savedAt||0))[0]?.savedAt,[p]),h=o.useCallback(async()=>{D(!0),_(null);try{const t=(await Z(n?.id)).map(s=>({id:s.id,name:s.name,thumbnail:s.thumbnail_url,duration:s.duration_seconds>0?`${Math.floor(s.duration_seconds/60)}:${String(Math.floor(s.duration_seconds%60)).padStart(2,"0")}`:"0:00",resolution:s.resolution||"1080p",savedAt:s.updated_at||s.created_at,isCloud:!s._source||s._source!=="localStorage"}));y(t)}catch(a){C.error("Failed to load projects",{error:a}),_(I(a,"project")),y([])}finally{D(!1)}},[n?.id]);o.useEffect(()=>{h();const a=()=>h();window.addEventListener("focus",a);const t=()=>h();return window.addEventListener("storage",t),()=>{window.removeEventListener("focus",a),window.removeEventListener("storage",t)}},[h]);const S=o.useCallback(()=>{v(j.dashboardNewProjectClick),x.current?.click()},[]),W=o.useCallback(a=>{const t=Array.from(a.target.files);t.length>0&&(v(j.dashboardFileImport,{fileCount:t.length}),r("/editor",{state:{filesToImport:t}})),a.target.value=""},[r]),Y=o.useCallback(a=>{v(j.dashboardProjectOpen,{projectId:a.id}),r("/editor",{state:{projectId:a.id,projectData:a.data,projectName:a.name}})},[r]),G=o.useCallback(async(a,t)=>{if(a.stopPropagation(),window.confirm("Are you sure you want to delete this project?"))try{await ee(t,n?.id),v(j.dashboardProjectDelete,{projectId:t}),y(s=>s.filter(f=>f.id!==t))}catch(s){C.error("Failed to delete project",{error:s,projectId:t}),alert(I(s,"project"))}},[n?.id]),Q=o.useCallback((a,t)=>{a.stopPropagation(),k(t.id),E(t.name)},[]),L=o.useCallback(async a=>{const t=N.trim();if(!t||t===p.find(s=>s.id===a)?.name){k(null);return}try{await ae(a,n?.id,{name:t}),y(s=>s.map(f=>f.id===a?{...f,name:t}:f))}catch(s){C.error("Failed to rename project",{error:s})}k(null)},[N,p,n?.id]),V=te(c),A=p.filter(a=>a.name.toLowerCase().includes(V.toLowerCase())),H=!b&&A.length>0,U=!b&&!w&&A.length===0;return e.jsxs("div",{className:"dash-root",children:[e.jsx("style",{children:ie}),e.jsx("input",{ref:x,type:"file",accept:"video/*,audio/*,image/*",multiple:!0,style:{display:"none"},onChange:W}),e.jsx("div",{className:`sidebar-overlay ${u?"visible":""}`,onClick:()=>g(!1)}),e.jsx(q,{user:n,activeNav:d,onNav:a=>{m(a),l&&g(!1)},onNavigate:r,isOpen:u,onClose:l?()=>g(!1):void 0}),e.jsxs("div",{className:"dash-content",children:[e.jsxs("header",{className:"top-bar",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[e.jsx("button",{className:"hamburger-btn",onClick:()=>g(a=>!a),"aria-label":"Open menu",children:e.jsx(i,{i:"menu",s:20})}),e.jsxs("div",{children:[e.jsxs("h1",{children:[se(),", ",O]}),e.jsx("p",{className:"top-bar-sub",children:"Workspace overview"})]})]}),e.jsxs("div",{className:"top-bar-actions",children:[e.jsx("button",{className:"icon-btn",onClick:h,title:"Refresh projects",children:e.jsx(i,{i:"refresh",s:18})}),e.jsx("button",{className:"icon-btn",onClick:()=>r("/settings"),title:"Settings",children:e.jsx(i,{i:"settings",s:18})})]})]}),e.jsx("div",{className:"dash-body",children:e.jsxs("div",{className:`dash-layout ${!l&&P?"dash-layout--single":""}`,children:[e.jsxs("div",{className:"dash-main",children:[e.jsxs("div",{className:"stats-row",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"folder",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:b?"—":p.length}),e.jsx("span",{className:"stat-label",children:"Projects"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"schedule",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:b?"—":z(B)}),e.jsx("span",{className:"stat-label",children:"Last edited"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"calendar_month",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:oe(n?.created_at)}),e.jsx("span",{className:"stat-label",children:"Member since"})]})]})]}),e.jsx("div",{className:"section-label",children:"Quick Actions"}),e.jsxs("div",{className:"quick-actions",children:[e.jsxs("button",{className:"quick-action quick-action--primary",onClick:S,children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"add",s:20,c:"white"})}),e.jsx("span",{children:"New Project"})]}),e.jsxs("button",{className:"quick-action",onClick:()=>{v(j.dashboardToolSelect,{tool:"long_to_shorts"}),r("/long-to-shorts")},children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"content_cut",s:18,c:"#75AADB"})}),e.jsx("span",{children:"Long to Shorts"}),e.jsx("span",{className:"qa-badge",children:"AI"})]})]}),e.jsxs("div",{className:"projects-header",children:[e.jsx("div",{className:"section-label",style:{margin:0},children:"Your Projects"}),p.length>0&&e.jsxs("div",{className:"proj-search",children:[e.jsx(i,{i:"search"}),e.jsx("input",{type:"text",placeholder:"Search...","aria-label":"Search projects",value:c,onChange:a=>F(a.target.value)})]})]}),w&&e.jsxs("div",{className:"error-banner",children:[e.jsx(i,{i:"cloud_off",s:18,c:"#ef4444"}),e.jsx("span",{children:w}),e.jsx("button",{className:"error-retry",onClick:h,children:"Retry"})]}),b&&!w&&e.jsx("div",{className:"projects-grid",children:[1,2,3,4,5,6].map(a=>e.jsxs("div",{className:"project-card",style:{pointerEvents:"none"},children:[e.jsx("div",{className:"project-thumb skel"}),e.jsxs("div",{className:"project-info",children:[e.jsx("div",{style:{width:"65%",height:"12px",borderRadius:"4px",background:"#1a2332",marginBottom:"5px"}}),e.jsx("div",{style:{width:"35%",height:"10px",borderRadius:"4px",background:"#151b24"}})]})]},a))}),H&&e.jsx("div",{className:"projects-grid",children:A.map(a=>e.jsxs("div",{className:"project-card",onClick:()=>Y(a),children:[e.jsxs("div",{className:"project-thumb",children:[a.thumbnail?e.jsx("img",{src:a.thumbnail,alt:a.name}):e.jsx(i,{i:"movie",s:32,c:"rgba(255,255,255,0.1)"}),e.jsx("button",{className:"del-btn",onClick:t=>G(t,a.id),"aria-label":`Delete project ${a.name}`,title:"Delete project",children:e.jsx(i,{i:"delete",s:14,c:"white"})})]}),e.jsxs("div",{className:"project-info",children:[R===a.id?e.jsx("input",{autoFocus:!0,value:N,onChange:t=>E(t.target.value),onBlur:()=>L(a.id),onKeyDown:t=>{t.key==="Enter"&&L(a.id),t.key==="Escape"&&k(null)},onClick:t=>t.stopPropagation(),style:{background:"rgba(117,170,219,0.1)",border:"1px solid rgba(117,170,219,0.3)",borderRadius:"4px",padding:"2px 6px",color:"white",fontSize:"13px",fontWeight:600,fontFamily:"inherit",width:"100%",outline:"none"}}):e.jsx("p",{className:"name",onDoubleClick:t=>Q(t,a),title:"Double-click to rename",children:a.name}),e.jsxs("p",{className:"meta",children:[a.resolution," · ",a.duration||"0:00"," · ",z(a.savedAt)]})]})]},a.id))}),U&&e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:e.jsx(i,{i:"movie_edit",s:26,c:"rgba(117,170,219,0.5)"})}),e.jsx("h3",{children:"Your workspace is ready"}),e.jsx("p",{children:"Import a video, image, or audio file to create your first project and start editing."}),e.jsxs("div",{className:"empty-actions",children:[e.jsxs("button",{className:"empty-btn empty-btn--primary",onClick:S,children:[e.jsx(i,{i:"add",s:16,c:"#0a0a0a"}),"Import Media"]}),e.jsxs("button",{className:"empty-btn empty-btn--ghost",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:14}),"Long to Shorts"]})]}),e.jsx("p",{className:"empty-hint",children:"Supports MP4, WebM, MP3, WAV, PNG, JPG and more"})]})]}),!l&&!P&&e.jsxs("aside",{className:"advisor-panel",children:[e.jsxs("div",{className:"advisor-label-row",children:[e.jsxs("div",{className:"advisor-label",children:[e.jsx(i,{i:"assistant",s:14,c:"rgba(255,255,255,0.25)"}),"Advisor"]}),e.jsx("button",{type:"button",className:"advisor-dismiss",onClick:$,"aria-label":"Dismiss advisor panel",title:"Hide advisor",children:e.jsx(i,{i:"close",s:18})})]}),e.jsxs("div",{className:"advisor-item advisor-item--warning",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"shield",s:16,c:"#f59e0b"}),e.jsx("h4",{children:"Account Security"})]}),e.jsx("p",{children:"Strengthen your account by reviewing your security settings."}),e.jsxs("button",{className:"advisor-action advisor-action--warning",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#f59e0b"}),"Review Settings"]})]}),p.length===0&&!b?e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"rocket_launch",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Getting Started"})]}),e.jsxs("ul",{className:"advisor-checklist",children:[e.jsxs("li",{className:"done",children:[e.jsx(i,{i:"check_circle",s:14,fill:!0}),e.jsx("span",{children:"Create account"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Import your first media file"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Edit and export a project"})]})]})]}):p.length>0?e.jsxs("div",{className:"advisor-item advisor-item--success",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"check_circle",s:16,c:"#22c55e"}),e.jsx("h4",{children:"Workspace Active"})]}),e.jsxs("p",{children:[p.length," project",p.length!==1?"s":""," in your workspace. Last edited ",z(B),"."]})]}):null,e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"auto_awesome",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Long to Shorts"})]}),e.jsx("p",{children:"Convert landscape videos to vertical format with AI-powered speaker tracking and smart reframing."}),e.jsxs("button",{className:"advisor-action advisor-action--info",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#75AADB"}),"Try it"]})]})]})]})})]}),l&&e.jsxs("nav",{className:"mobile-bottom-nav",children:[e.jsxs("button",{className:d==="home"?"active":"",onClick:()=>m("home"),children:[e.jsx(i,{i:"home",s:22,fill:d==="home"}),e.jsx("span",{children:"Home"})]}),e.jsxs("button",{onClick:S,children:[e.jsx(i,{i:"add_circle",s:22,c:"#75AADB"}),e.jsx("span",{children:"New"})]}),e.jsxs("button",{className:d==="shorts"?"active":"",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:22}),e.jsx("span",{children:"Shorts"})]}),e.jsxs("button",{className:d==="settings"?"active":"",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"settings",s:22}),e.jsx("span",{children:"Settings"})]})]}),e.jsxs("div",{className:"bw-stripe",role:"presentation",children:[e.jsx("div",{style:{background:"#75AADB"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#000"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#75AADB"}})]})]})};export{ge as default};
