import{r as t,j as e}from"./DwQPoapS.js";import{t as r,d as y,b as n}from"./CIdVyh80.js";import{f as p}from"./Et-wlZO3.js";import{v as w}from"./Bs4D8IiQ.js";import{B as k}from"./D8AsaMNA.js";import"./C_8A2FPv.js";const j=`
...
`,B=({onContinue:b,onSkip:m,onSkipAll:f})=>{const[x,g]=t.useState(""),[l,h]=t.useState(""),[o,u]=t.useState(null),i=t.useRef(null);t.useEffect(()=>{r(n.onboardingStart)},[]);const v=a=>{const s=a.target.files[0];if(!s)return;const d=w(s,{allowedCategories:["image"],category:"avatar"});if(!d.valid){y.error(d.error||"Invalid avatar image"),a.target.value="";return}const c=new FileReader;c.onloadend=()=>u(c.result),c.readAsDataURL(s)};return e.jsxs("div",{className:"ob1-root",children:[e.jsx("style",{children:j}),e.jsx("span",{className:"ob1-bg-num","aria-hidden":"true",children:"01"}),e.jsxs("header",{className:"ob1-header",children:[e.jsxs("div",{className:"ob1-brand",children:[e.jsx("span",{className:"ob1-brand-mono","aria-hidden":"true",children:"CC"}),e.jsx("span",{className:"ob1-brand-name",children:"ClipCut"})]}),e.jsxs("div",{className:"ob1-progress",children:[e.jsxs("div",{className:"ob1-progress-strokes","aria-hidden":"true",children:[e.jsx("div",{className:"ob1-stroke is-active"}),e.jsx("div",{className:"ob1-stroke"}),e.jsx("div",{className:"ob1-stroke"})]}),e.jsx("span",{className:"ob1-step-label",children:"Step 1 · of 3"})]})]}),e.jsx("main",{className:"ob1-main",children:e.jsxs("div",{className:"ob1-container",children:[e.jsxs("div",{className:"ob1-heading",children:[e.jsx("div",{className:"ob1-eyebrow",children:"Your profile"}),e.jsxs("h1",{className:"ob1-title",children:["Who's behind",e.jsx("br",{}),"the ",e.jsx("span",{className:"ob1-title-em",children:"cut?"})]}),e.jsx("p",{className:"ob1-subtitle",children:"Set up your creator identity. You can change any of this later in Settings."})]}),e.jsxs("div",{className:"ob1-avatar-section",children:[e.jsxs("div",{className:`ob1-avatar-btn ${o?"has-image":""}`,role:"button",tabIndex:0,"aria-label":"Upload profile photo",onClick:()=>i.current?.click(),onKeyDown:a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),i.current?.click())},style:o?{backgroundImage:`url(${o})`}:{},children:[!o&&e.jsxs("div",{className:"ob1-avatar-placeholder",children:[e.jsx("span",{className:"material-symbols-outlined",children:"add_a_photo"}),e.jsx("span",{className:"ob1-avatar-placeholder-text",children:"Upload"})]}),e.jsx("div",{className:"ob1-avatar-edit","aria-hidden":"true",children:e.jsx("span",{className:"material-symbols-outlined",style:{fontSize:"14px",color:"#0a0a0a"},children:"edit"})})]}),e.jsx("input",{ref:i,type:"file",accept:"image/*",style:{display:"none"},onChange:v})]}),e.jsxs("form",{className:"ob1-form",onSubmit:a=>a.preventDefault(),children:[e.jsxs("div",{className:"ob1-field",children:[e.jsx("label",{htmlFor:"ob1-name",className:"ob1-label",children:"Display Name"}),e.jsx("input",{id:"ob1-name",className:"ob1-input",type:"text",placeholder:"What should we call you?",value:x,onChange:a=>g(p(a.target.value,{maxLength:100})),autoComplete:"name"})]}),e.jsxs("div",{className:"ob1-field",children:[e.jsx("label",{htmlFor:"ob1-bio",className:"ob1-label",children:"Bio"}),e.jsx("textarea",{id:"ob1-bio",className:"ob1-input ob1-textarea",placeholder:"Tell us about your editing style…",value:l,onChange:a=>h(p(a.target.value,{maxLength:500,allowNewlines:!0})),rows:3}),e.jsxs("div",{className:"ob1-char-count",children:[l.length,"/500"]})]}),e.jsxs("div",{className:"ob1-actions",children:[e.jsxs("button",{type:"submit",className:"ob1-btn-primary",onClick:()=>{r(n.onboardingContinue,{step:"1"}),b?.()},children:["Continue",e.jsx("span",{className:"arrow","aria-hidden":"true",children:"→"})]}),e.jsx("button",{type:"button",className:"ob1-btn-skip",onClick:()=>{r(n.onboardingSkip,{step:"1"}),m?.()},children:"Skip this step"}),e.jsx("button",{type:"button",className:"ob1-btn-skip-all",onClick:()=>{r(n.onboardingSkip,{step:"1",action:"skip_all"}),f?.()},children:"Skip onboarding entirely"})]})]})]})}),e.jsx(k,{})]})};export{B as default};
