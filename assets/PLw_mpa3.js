import{u as oe,r as s,j as e}from"./-P2Ya96f.js";import{u as ne,l as S,g as W,t as j,b as y}from"./BwzjLjtb.js";import{u as le,l as de,a as Y,d as ce,b as pe,s as xe}from"./CLIDfK6B.js";import{h as ge}from"./Et-wlZO3.js";import"./DZxFKcQQ.js";import"./B9CjrYEi.js";const O="clipcut-dashboard-advisor-dismissed",me=`
...
`,a=({i:r,s:n=20,c:d,fill:g=!1,style:c})=>e.jsx("span",{className:"material-symbols-outlined",style:{fontSize:n,color:d,fontVariationSettings:g?"'FILL' 1":"'FILL' 0",...c},children:r}),be=[{id:"home",icon:"home",label:"Home",fill:!0},{id:"templates",icon:"dashboard",label:"Templates"},{id:"shorts",icon:"content_cut",label:"Long to Shorts"},{id:"divider"},{id:"settings",icon:"settings",label:"Settings"}];function L(r){if(!r)return"Never";const n=Date.now()-new Date(r).getTime(),d=Math.floor(n/6e4);if(d<1)return"Just now";if(d<60)return`${d}m ago`;const g=Math.floor(d/60);if(g<24)return`${g}h ago`;const c=Math.floor(g/24);return c<7?`${c}d ago`:c<30?`${Math.floor(c/7)}w ago`:new Date(r).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function he(r){return r?`${new Date(r).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})} · ${L(r)}`:"Never"}function ue(){const r=new Date().getHours();return r<12?"Good morning":r<18?"Good afternoon":"Good evening"}function fe(r){return r?new Date(r).toLocaleDateString("en-US",{month:"short",year:"numeric"}):"—"}const G=s.memo(({user:r,activeNav:n,onNav:d,onNavigate:g,isOpen:c,onClose:f})=>{const v=r?.user_metadata?.full_name||r?.email?.split("@")[0]||"Creator",h=v.charAt(0).toUpperCase();return e.jsxs("aside",{className:`sidebar ${c?"sidebar-open":""}`,children:[f&&e.jsx("button",{className:"sidebar-close-btn",onClick:f,"aria-label":"Close menu",children:e.jsx(a,{i:"close",s:18})}),e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("div",{className:"sidebar-logo-icon",children:e.jsx(a,{i:"content_cut",s:16,c:"white"})}),e.jsx("span",{style:{fontSize:"16px",fontWeight:700},children:"ClipCut"})]}),e.jsxs("div",{className:"sidebar-user",children:[e.jsx("div",{className:"sidebar-avatar",children:h}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("p",{style:{fontSize:"12px",fontWeight:600,margin:0,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:v}),e.jsx("p",{style:{fontSize:"10px",color:"rgba(255,255,255,0.25)",margin:0},children:"Free Plan"})]})]}),e.jsx("nav",{className:"sidebar-nav",children:be.map(p=>p.id==="divider"?e.jsx("div",{className:"nav-divider"},"div"):e.jsxs("button",{className:`nav-item ${n===p.id?"active":""}`,onClick:()=>{d(p.id),p.id==="shorts"?g("/long-to-shorts"):p.id==="settings"&&g("/settings")},children:[e.jsx(a,{i:p.icon,s:20,fill:p.fill&&n===p.id}),e.jsx("span",{style:{flex:1},children:p.label})]},p.id))}),e.jsx("div",{className:"sidebar-footer",children:"v0.1.0 beta"})]})});G.displayName="Sidebar";const Ce=()=>{const r=oe(),{user:n}=ne(),d=le(),g=s.useRef(null),[c,f]=s.useState("home"),[v,h]=s.useState(!1),[p,V]=s.useState(""),[x,w]=s.useState([]),[u,M]=s.useState(!0),[k,B]=s.useState(null),[Q,N]=s.useState(null),[A,I]=s.useState(""),[U,H]=s.useState(new Set),[F,J]=s.useState(()=>{try{return typeof window<"u"&&localStorage.getItem(O)==="1"}catch{return!1}}),K=s.useCallback(()=>{try{localStorage.setItem(O,"1")}catch{}J(!0)},[]),X=n?.user_metadata?.full_name||n?.email?.split("@")[0]||"Creator",q=s.useMemo(()=>x.length===0?null:[...x].sort((i,l)=>new Date(l.savedAt||0)-new Date(i.savedAt||0))[0]?.savedAt,[x]),R=s.useCallback(t=>{if(t.name&&t.name!=="Untitled Project")return t.name;const l=(t.project_data?.clips||[]).find(o=>o.type==="video"&&o.name);return l?.name&&l.name.replace(/\.[^.]+$/,"").trim()||t.name},[]),m=s.useCallback(async()=>{M(!0),B(null);try{const t=await de(n?.id),i=[];for(const o of t){const E=R(o);E!==o.name&&(o.name=E,i.push(Y(o.id,n?.id,{name:E}).catch(()=>{})))}i.length>0&&Promise.all(i);const l=t.map(o=>({id:o.id,name:o.name,thumbnail:o.thumbnail_url||o.project_data?.thumbnailDataUrl||null,duration:o.duration_seconds>0?`${Math.floor(o.duration_seconds/60)}:${String(Math.floor(o.duration_seconds%60)).padStart(2,"0")}`:"0:00",resolution:o.resolution||"1080p",savedAt:o.updated_at||o.created_at,isCloud:!o._source||o._source!=="localStorage"}));w(l)}catch(t){S.error("Failed to load projects",{error:t}),B(W(t,"project")),w([])}finally{M(!1)}},[n?.id,R]);s.useEffect(()=>{m();const t=()=>m();window.addEventListener("focus",t);const i=()=>m();return window.addEventListener("storage",i),()=>{window.removeEventListener("focus",t),window.removeEventListener("storage",i)}},[m]);const z=s.useCallback(()=>{j(y.dashboardNewProjectClick),g.current?.click()},[]),Z=s.useCallback(t=>{const i=Array.from(t.target.files);i.length>0&&(j(y.dashboardFileImport,{fileCount:i.length}),r("/editor",{state:{filesToImport:i}})),t.target.value=""},[r]),ee=s.useCallback(t=>{j(y.dashboardProjectOpen,{projectId:t.id}),r("/editor",{state:{projectId:t.id,projectName:t.name}})},[r]),$=s.useCallback(async(t,i)=>{if(t.stopPropagation(),window.confirm("Are you sure you want to delete this project?"))try{await ce(i,n?.id),j(y.dashboardProjectDelete,{projectId:i}),w(l=>l.filter(o=>o.id!==i))}catch(l){S.error("Failed to delete project",{error:l,projectId:i}),alert(W(l,"project"))}},[n?.id]),D=s.useCallback((t,i)=>{t.stopPropagation(),N(i.id),I(i.name)},[]),T=s.useCallback(async t=>{const i=A.trim();if(!i||i===x.find(l=>l.id===t)?.name){N(null);return}try{await Y(t,n?.id,{name:i}),w(l=>l.map(o=>o.id===t?{...o,name:i}:o))}catch(l){S.error("Failed to rename project",{error:l})}N(null)},[A,x,n?.id]),[b,_]=s.useState(null),te=s.useCallback((t,i)=>{t.preventDefault(),t.stopPropagation(),_({x:t.clientX,y:t.clientY,project:i})},[]),C=s.useCallback(()=>_(null),[]);s.useEffect(()=>{if(!b)return;const t=()=>_(null);return window.addEventListener("click",t),window.addEventListener("contextmenu",t),()=>{window.removeEventListener("click",t),window.removeEventListener("contextmenu",t)}},[b]);const ie=s.useCallback(async t=>{C();try{const i=await pe(t.id,n?.id);if(!i)return;await xe(n?.id,{name:`${t.name} (copy)`,clips:i.project_data?.clips||[],duration:i.duration_seconds||0,resolution:i.resolution||"1080p"})&&m()}catch(i){S.error("Failed to duplicate project",{error:i})}},[n?.id,C,m]),ae=ge(p),P=x.filter(t=>t.name.toLowerCase().includes(ae.toLowerCase())),re=!u&&P.length>0,se=!u&&!k&&P.length===0;return e.jsxs("div",{className:"dash-root",children:[e.jsx("style",{children:me}),e.jsx("input",{ref:g,type:"file",accept:"video/*,audio/*,image/*",multiple:!0,style:{display:"none"},onChange:Z}),e.jsx("div",{className:`sidebar-overlay ${v?"visible":""}`,onClick:()=>h(!1)}),e.jsx(G,{user:n,activeNav:c,onNav:t=>{f(t),d&&h(!1)},onNavigate:r,isOpen:v,onClose:d?()=>h(!1):void 0}),e.jsxs("div",{className:"dash-content",children:[e.jsxs("header",{className:"top-bar",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[e.jsx("button",{className:"hamburger-btn",onClick:()=>h(t=>!t),"aria-label":"Open menu",children:e.jsx(a,{i:"menu",s:20})}),e.jsxs("div",{children:[e.jsxs("h1",{children:[ue(),", ",X]}),e.jsx("p",{className:"top-bar-sub",children:"Workspace overview"})]})]}),e.jsxs("div",{className:"top-bar-actions",children:[e.jsx("button",{className:"icon-btn",onClick:m,title:"Refresh projects",children:e.jsx(a,{i:"refresh",s:18})}),e.jsx("button",{className:"icon-btn",onClick:()=>r("/settings"),title:"Settings",children:e.jsx(a,{i:"settings",s:18})})]})]}),e.jsx("div",{className:"dash-body",children:e.jsxs("div",{className:`dash-layout ${!d&&F?"dash-layout--single":""}`,children:[e.jsxs("div",{className:"dash-main",children:[e.jsxs("div",{className:"stats-row",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(a,{i:"folder",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:u?"—":x.length}),e.jsx("span",{className:"stat-label",children:"Projects"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(a,{i:"schedule",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:u?"—":L(q)}),e.jsx("span",{className:"stat-label",children:"Last edited"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(a,{i:"calendar_month",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:fe(n?.created_at)}),e.jsx("span",{className:"stat-label",children:"Member since"})]})]})]}),e.jsx("div",{className:"section-label",children:"Quick Actions"}),e.jsxs("div",{className:"quick-actions",children:[e.jsxs("button",{className:"quick-action quick-action--primary",onClick:z,children:[e.jsx("div",{className:"qa-icon",children:e.jsx(a,{i:"add",s:20,c:"white"})}),e.jsx("span",{children:"New Project"})]}),e.jsxs("button",{className:"quick-action",onClick:()=>{j(y.dashboardToolSelect,{tool:"long_to_shorts"}),r("/long-to-shorts")},children:[e.jsx("div",{className:"qa-icon",children:e.jsx(a,{i:"content_cut",s:18,c:"#75AADB"})}),e.jsx("span",{children:"Long to Shorts"}),e.jsx("span",{className:"qa-badge",children:"AI"})]})]}),e.jsxs("div",{className:"projects-header",children:[e.jsx("div",{className:"section-label",style:{margin:0},children:"Your Projects"}),x.length>0&&e.jsxs("div",{className:"proj-search",children:[e.jsx(a,{i:"search"}),e.jsx("input",{type:"text",placeholder:"Search...","aria-label":"Search projects",value:p,onChange:t=>V(t.target.value)})]})]}),k&&e.jsxs("div",{className:"error-banner",children:[e.jsx(a,{i:"cloud_off",s:18,c:"#ef4444"}),e.jsx("span",{children:k}),e.jsx("button",{className:"error-retry",onClick:m,children:"Retry"})]}),u&&!k&&e.jsx("div",{className:"projects-grid",children:[1,2,3,4,5,6].map(t=>e.jsxs("div",{className:"project-card",style:{pointerEvents:"none"},children:[e.jsx("div",{className:"project-thumb skel"}),e.jsxs("div",{className:"project-info",children:[e.jsx("div",{style:{width:"65%",height:"12px",borderRadius:"4px",background:"#1a2332",marginBottom:"5px"}}),e.jsx("div",{style:{width:"35%",height:"10px",borderRadius:"4px",background:"#151b24"}})]})]},t))}),re&&e.jsx("div",{className:"projects-grid",children:P.map(t=>e.jsxs("div",{className:"project-card",onClick:()=>ee(t),onContextMenu:i=>te(i,t),children:[e.jsxs("div",{className:"project-thumb",children:[t.thumbnail&&!U.has(t.id)?e.jsx("img",{src:t.thumbnail,alt:t.name,style:{width:"100%",height:"100%",objectFit:"cover"},onError:()=>H(i=>new Set(i).add(t.id))}):e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",position:"absolute",inset:0,background:"linear-gradient(135deg, #111820, #0e1218)"},children:e.jsx(a,{i:"movie",s:32,c:"rgba(117,170,219,0.2)"})}),e.jsx("button",{className:"del-btn",onClick:i=>$(i,t.id),"aria-label":`Delete project ${t.name}`,title:"Delete project",children:e.jsx(a,{i:"delete",s:14,c:"white"})})]}),e.jsxs("div",{className:"project-info",children:[Q===t.id?e.jsx("input",{autoFocus:!0,value:A,onChange:i=>I(i.target.value),onBlur:()=>T(t.id),onKeyDown:i=>{i.key==="Enter"&&T(t.id),i.key==="Escape"&&N(null)},onClick:i=>i.stopPropagation(),style:{background:"rgba(117,170,219,0.1)",border:"1px solid rgba(117,170,219,0.3)",borderRadius:"4px",padding:"2px 6px",color:"white",fontSize:"13px",fontWeight:600,fontFamily:"inherit",width:"100%",outline:"none"}}):e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"4px",minWidth:0},children:[e.jsx("p",{className:"name",onClick:i=>D(i,t),title:"Click to rename",style:{cursor:"text",flex:1,minWidth:0},children:t.name}),e.jsx("button",{onClick:i=>D(i,t),style:{background:"none",border:"none",cursor:"pointer",padding:"2px",opacity:.4,flexShrink:0,display:"flex",alignItems:"center"},title:"Rename","aria-label":`Rename ${t.name}`,children:e.jsx(a,{i:"edit",s:12,c:"rgba(255,255,255,0.5)"})})]}),e.jsxs("p",{className:"meta",children:[t.resolution," · ",he(t.savedAt)]})]})]},t.id))}),b&&e.jsxs("div",{className:"ctx-menu",style:{left:b.x,top:b.y},children:[e.jsxs("button",{className:"ctx-menu-item",onClick:()=>{D({stopPropagation:()=>{}},b.project),C()},children:[e.jsx(a,{i:"edit",s:14})," Rename"]}),e.jsxs("button",{className:"ctx-menu-item",onClick:()=>ie(b.project),children:[e.jsx(a,{i:"content_copy",s:14})," Duplicate"]}),e.jsx("div",{className:"ctx-menu-sep"}),e.jsxs("button",{className:"ctx-menu-item ctx-menu-item--danger",onClick:t=>{$(t,b.project.id),C()},children:[e.jsx(a,{i:"delete",s:14})," Delete"]})]}),se&&e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:e.jsx(a,{i:"movie_edit",s:26,c:"rgba(117,170,219,0.5)"})}),e.jsx("h3",{children:"Your workspace is ready"}),e.jsx("p",{children:"Import a video, image, or audio file to create your first project and start editing."}),e.jsxs("div",{className:"empty-actions",children:[e.jsxs("button",{className:"empty-btn empty-btn--primary",onClick:z,children:[e.jsx(a,{i:"add",s:16,c:"#0a0a0a"}),"Import Media"]}),e.jsxs("button",{className:"empty-btn empty-btn--ghost",onClick:()=>r("/long-to-shorts"),children:[e.jsx(a,{i:"content_cut",s:14}),"Long to Shorts"]})]}),e.jsx("p",{className:"empty-hint",children:"Supports MP4, WebM, MP3, WAV, PNG, JPG and more"})]})]}),!d&&!F&&e.jsxs("aside",{className:"advisor-panel",children:[e.jsxs("div",{className:"advisor-label-row",children:[e.jsxs("div",{className:"advisor-label",children:[e.jsx(a,{i:"assistant",s:14,c:"rgba(255,255,255,0.25)"}),"Advisor"]}),e.jsx("button",{type:"button",className:"advisor-dismiss",onClick:K,"aria-label":"Dismiss advisor panel",title:"Hide advisor",children:e.jsx(a,{i:"close",s:18})})]}),e.jsxs("div",{className:"advisor-item advisor-item--warning",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(a,{i:"shield",s:16,c:"#f59e0b"}),e.jsx("h4",{children:"Account Security"})]}),e.jsx("p",{children:"Strengthen your account by reviewing your security settings."}),e.jsxs("button",{className:"advisor-action advisor-action--warning",onClick:()=>r("/settings"),children:[e.jsx(a,{i:"arrow_forward",s:12,c:"#f59e0b"}),"Review Settings"]})]}),x.length===0&&!u?e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(a,{i:"rocket_launch",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Getting Started"})]}),e.jsxs("ul",{className:"advisor-checklist",children:[e.jsxs("li",{className:"done",children:[e.jsx(a,{i:"check_circle",s:14,fill:!0}),e.jsx("span",{children:"Create account"})]}),e.jsxs("li",{children:[e.jsx(a,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Import your first media file"})]}),e.jsxs("li",{children:[e.jsx(a,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Edit and export a project"})]})]})]}):x.length>0?e.jsxs("div",{className:"advisor-item advisor-item--success",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(a,{i:"check_circle",s:16,c:"#22c55e"}),e.jsx("h4",{children:"Workspace Active"})]}),e.jsxs("p",{children:[x.length," project",x.length!==1?"s":""," in your workspace. Last edited ",L(q),"."]})]}):null,e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(a,{i:"auto_awesome",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Long to Shorts"})]}),e.jsx("p",{children:"Convert landscape videos to vertical format with AI-powered speaker tracking and smart reframing."}),e.jsxs("button",{className:"advisor-action advisor-action--info",onClick:()=>r("/long-to-shorts"),children:[e.jsx(a,{i:"arrow_forward",s:12,c:"#75AADB"}),"Try it"]})]})]})]})})]}),d&&e.jsxs("nav",{className:"mobile-bottom-nav",children:[e.jsxs("button",{className:c==="home"?"active":"",onClick:()=>f("home"),children:[e.jsx(a,{i:"home",s:22,fill:c==="home"}),e.jsx("span",{children:"Home"})]}),e.jsxs("button",{onClick:z,children:[e.jsx(a,{i:"add_circle",s:22,c:"#75AADB"}),e.jsx("span",{children:"New"})]}),e.jsxs("button",{className:c==="shorts"?"active":"",onClick:()=>r("/long-to-shorts"),children:[e.jsx(a,{i:"content_cut",s:22}),e.jsx("span",{children:"Shorts"})]}),e.jsxs("button",{className:c==="settings"?"active":"",onClick:()=>r("/settings"),children:[e.jsx(a,{i:"settings",s:22}),e.jsx("span",{children:"Settings"})]})]}),e.jsxs("div",{className:"bw-stripe",role:"presentation",children:[e.jsx("div",{style:{background:"#75AADB"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#000"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#75AADB"}})]})]})};export{Ce as default};
