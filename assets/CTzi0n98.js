import{u as ne,r as s,j as e}from"./DwQPoapS.js";import{u as le,l as A,g as O,t as y,b as w}from"./CYrKuRlX.js";import{u as de,l as ce,a as Y,d as pe,b as xe,s as ge}from"./Bl-z0EEz.js";import{h as me}from"./Et-wlZO3.js";import"./DZxFKcQQ.js";import"./B9CjrYEi.js";const G="clipcut-dashboard-advisor-dismissed",be=`
...
`,i=({i:r,s:n=20,c:x,fill:d=!1,style:g})=>e.jsx("span",{className:"material-symbols-outlined",style:{fontSize:n,color:x,fontVariationSettings:d?"'FILL' 1":"'FILL' 0",...g},children:r}),he=[{id:"home",icon:"home",label:"Home",fill:!0},{id:"templates",icon:"dashboard",label:"Templates"},{id:"shorts",icon:"content_cut",label:"Long to Shorts"},{id:"divider"},{id:"settings",icon:"settings",label:"Settings"}];function M(r){if(!r)return"Never";const n=Date.now()-new Date(r).getTime(),x=Math.floor(n/6e4);if(x<1)return"Just now";if(x<60)return`${x}m ago`;const d=Math.floor(x/60);if(d<24)return`${d}h ago`;const g=Math.floor(d/24);return g<7?`${g}d ago`:g<30?`${Math.floor(g/7)}w ago`:new Date(r).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function ue(r){return r?`${new Date(r).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})} · ${M(r)}`:"Never"}function fe(){const r=new Date().getHours();return r<12?"Good morning":r<18?"Good afternoon":"Good evening"}function ve(r){return r?new Date(r).toLocaleDateString("en-US",{month:"short",year:"numeric"}):"—"}const V=s.memo(({user:r,activeNav:n,onNav:x,onNavigate:d,onLogout:g,isOpen:h,onClose:v})=>{const j=r?.user_metadata?.full_name||r?.email?.split("@")[0]||"Creator",u=j.charAt(0).toUpperCase();return e.jsxs("aside",{className:`sidebar ${h?"sidebar-open":""}`,children:[v&&e.jsx("button",{className:"sidebar-close-btn",onClick:v,"aria-label":"Close menu",children:e.jsx(i,{i:"close",s:18})}),e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("div",{className:"sidebar-logo-icon",children:e.jsx(i,{i:"content_cut",s:16,c:"white"})}),e.jsx("span",{style:{fontSize:"16px",fontWeight:700},children:"ClipCut"})]}),e.jsxs("div",{className:"sidebar-user",children:[e.jsx("div",{className:"sidebar-avatar",children:u}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("p",{style:{fontSize:"12px",fontWeight:600,margin:0,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:j}),e.jsx("p",{style:{fontSize:"10px",color:"rgba(255,255,255,0.25)",margin:0},children:"Free Plan"})]})]}),e.jsx("nav",{className:"sidebar-nav",children:he.map(c=>c.id==="divider"?e.jsx("div",{className:"nav-divider"},"div"):e.jsxs("button",{className:`nav-item ${n===c.id?"active":""}`,onClick:()=>{x(c.id),c.id==="shorts"?d("/long-to-shorts"):c.id==="settings"&&d("/settings")},children:[e.jsx(i,{i:c.icon,s:20,fill:c.fill&&n===c.id}),e.jsx("span",{style:{flex:1},children:c.label})]},c.id))}),e.jsxs("button",{className:"sidebar-logout",onClick:g,children:[e.jsx(i,{i:"logout",s:20}),e.jsx("span",{style:{flex:1},children:"Log out"})]}),e.jsx("div",{className:"sidebar-footer",children:"v0.1.0 beta"})]})});V.displayName="Sidebar";const Se=()=>{const r=ne(),{user:n,signOut:x}=le(),d=de(),g=s.useRef(null),[h,v]=s.useState("home"),[j,u]=s.useState(!1),[c,Q]=s.useState(""),[p,k]=s.useState([]),[f,B]=s.useState(!0),[N,I]=s.useState(null),[U,C]=s.useState(null),[z,F]=s.useState(""),[H,J]=s.useState(new Set),[R,K]=s.useState(()=>{try{return typeof window<"u"&&localStorage.getItem(G)==="1"}catch{return!1}}),X=s.useCallback(()=>{try{localStorage.setItem(G,"1")}catch{}K(!0)},[]),Z=n?.user_metadata?.full_name||n?.email?.split("@")[0]||"Creator",q=s.useMemo(()=>p.length===0?null:[...p].sort((a,l)=>new Date(l.savedAt||0)-new Date(a.savedAt||0))[0]?.savedAt,[p]),T=s.useCallback(t=>{if(t.name&&t.name!=="Untitled Project")return t.name;const l=(t.project_data?.clips||[]).find(o=>o.type==="video"&&o.name);return l?.name&&l.name.replace(/\.[^.]+$/,"").trim()||t.name},[]),m=s.useCallback(async()=>{B(!0),I(null);try{const t=await ce(n?.id),a=[];for(const o of t){const L=T(o);L!==o.name&&(o.name=L,a.push(Y(o.id,n?.id,{name:L}).catch(()=>{})))}a.length>0&&Promise.all(a);const l=t.map(o=>({id:o.id,name:o.name,thumbnail:o.thumbnail_url||o.project_data?.thumbnailDataUrl||null,duration:o.duration_seconds>0?`${Math.floor(o.duration_seconds/60)}:${String(Math.floor(o.duration_seconds%60)).padStart(2,"0")}`:"0:00",resolution:o.resolution||"1080p",savedAt:o.updated_at||o.created_at,isCloud:!o._source||o._source!=="localStorage"}));k(l)}catch(t){A.error("Failed to load projects",{error:t}),I(O(t,"project")),k([])}finally{B(!1)}},[n?.id,T]);s.useEffect(()=>{m();let t=Date.now();const a=()=>{Date.now()-t<3e4||(t=Date.now(),m())};window.addEventListener("focus",a);const l=()=>{t=Date.now(),m()};return window.addEventListener("storage",l),()=>{window.removeEventListener("focus",a),window.removeEventListener("storage",l)}},[m]);const D=s.useCallback(()=>{y(w.dashboardNewProjectClick),g.current?.click()},[]),ee=s.useCallback(t=>{const a=Array.from(t.target.files);a.length>0&&(y(w.dashboardFileImport,{fileCount:a.length}),r("/editor",{state:{filesToImport:a}})),t.target.value=""},[r]),te=s.useCallback(t=>{y(w.dashboardProjectOpen,{projectId:t.id}),r("/editor",{state:{projectId:t.id,projectName:t.name}})},[r]),$=s.useCallback(async(t,a)=>{if(t.stopPropagation(),window.confirm("Are you sure you want to delete this project?"))try{await pe(a,n?.id),y(w.dashboardProjectDelete,{projectId:a}),k(l=>l.filter(o=>o.id!==a))}catch(l){A.error("Failed to delete project",{error:l,projectId:a}),alert(O(l,"project"))}},[n?.id]),_=s.useCallback((t,a)=>{t.stopPropagation(),C(a.id),F(a.name)},[]),W=s.useCallback(async t=>{const a=z.trim();if(!a||a===p.find(l=>l.id===t)?.name){C(null);return}try{await Y(t,n?.id,{name:a}),k(l=>l.map(o=>o.id===t?{...o,name:a}:o))}catch(l){A.error("Failed to rename project",{error:l})}C(null)},[z,p,n?.id]),[b,P]=s.useState(null),ae=s.useCallback((t,a)=>{t.preventDefault(),t.stopPropagation(),P({x:t.clientX,y:t.clientY,project:a})},[]),S=s.useCallback(()=>P(null),[]);s.useEffect(()=>{if(!b)return;const t=()=>P(null);return window.addEventListener("click",t),window.addEventListener("contextmenu",t),()=>{window.removeEventListener("click",t),window.removeEventListener("contextmenu",t)}},[b]);const ie=s.useCallback(async t=>{S();try{const a=await xe(t.id,n?.id);if(!a)return;await ge(n?.id,{name:`${t.name} (copy)`,clips:a.project_data?.clips||[],duration:a.duration_seconds||0,resolution:a.resolution||"1080p"})&&m()}catch(a){A.error("Failed to duplicate project",{error:a})}},[n?.id,S,m]),re=me(c),E=p.filter(t=>t.name.toLowerCase().includes(re.toLowerCase())),se=!f&&E.length>0,oe=!f&&!N&&E.length===0;return e.jsxs("div",{className:"dash-root",children:[e.jsx("style",{children:be}),e.jsx("input",{ref:g,type:"file",accept:"video/*,audio/*,image/*",multiple:!0,style:{display:"none"},onChange:ee}),e.jsx("div",{className:`sidebar-overlay ${j?"visible":""}`,onClick:()=>u(!1)}),e.jsx(V,{user:n,activeNav:h,onNav:t=>{v(t),d&&u(!1)},onNavigate:r,onLogout:async()=>{await x(),r("/login")},isOpen:j,onClose:d?()=>u(!1):void 0}),e.jsxs("div",{className:"dash-content",children:[e.jsxs("header",{className:"top-bar",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[e.jsx("button",{className:"hamburger-btn",onClick:()=>u(t=>!t),"aria-label":"Open menu",children:e.jsx(i,{i:"menu",s:20})}),e.jsxs("div",{children:[e.jsxs("h1",{children:[fe(),", ",Z]}),e.jsx("p",{className:"top-bar-sub",children:"Workspace overview"})]})]}),e.jsxs("div",{className:"top-bar-actions",children:[e.jsx("button",{className:"icon-btn",onClick:m,title:"Refresh projects",children:e.jsx(i,{i:"refresh",s:18})}),e.jsx("button",{className:"icon-btn",onClick:()=>r("/settings"),title:"Settings",children:e.jsx(i,{i:"settings",s:18})})]})]}),e.jsx("div",{className:"dash-body",children:e.jsxs("div",{className:`dash-layout ${!d&&R?"dash-layout--single":""}`,children:[e.jsxs("div",{className:"dash-main",children:[e.jsxs("div",{className:"stats-row",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"folder",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:f?"—":p.length}),e.jsx("span",{className:"stat-label",children:"Projects"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"schedule",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:f?"—":M(q)}),e.jsx("span",{className:"stat-label",children:"Last edited"})]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-icon",children:e.jsx(i,{i:"calendar_month",s:18,c:"#75AADB"})}),e.jsxs("div",{children:[e.jsx("span",{className:"stat-value",children:ve(n?.created_at)}),e.jsx("span",{className:"stat-label",children:"Member since"})]})]})]}),e.jsx("div",{className:"section-label",children:"Quick Actions"}),e.jsxs("div",{className:"quick-actions",children:[e.jsxs("button",{className:"quick-action quick-action--primary",onClick:D,children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"add",s:20,c:"white"})}),e.jsx("span",{children:"New Project"})]}),e.jsxs("button",{className:"quick-action",onClick:()=>{y(w.dashboardToolSelect,{tool:"long_to_shorts"}),r("/long-to-shorts")},children:[e.jsx("div",{className:"qa-icon",children:e.jsx(i,{i:"content_cut",s:18,c:"#75AADB"})}),e.jsx("span",{children:"Long to Shorts"}),e.jsx("span",{className:"qa-badge",children:"AI"})]})]}),e.jsxs("div",{className:"projects-header",children:[e.jsx("div",{className:"section-label",style:{margin:0},children:"Your Projects"}),p.length>0&&e.jsxs("div",{className:"proj-search",children:[e.jsx(i,{i:"search"}),e.jsx("input",{type:"text",placeholder:"Search...","aria-label":"Search projects",value:c,onChange:t=>Q(t.target.value)})]})]}),N&&e.jsxs("div",{className:"error-banner",children:[e.jsx(i,{i:"cloud_off",s:18,c:"#ef4444"}),e.jsx("span",{children:N}),e.jsx("button",{className:"error-retry",onClick:m,children:"Retry"})]}),f&&!N&&e.jsx("div",{className:"projects-grid",children:[1,2,3,4,5,6].map(t=>e.jsxs("div",{className:"project-card",style:{pointerEvents:"none"},children:[e.jsx("div",{className:"project-thumb skel"}),e.jsxs("div",{className:"project-info",children:[e.jsx("div",{style:{width:"65%",height:"12px",borderRadius:"4px",background:"#1a2332",marginBottom:"5px"}}),e.jsx("div",{style:{width:"35%",height:"10px",borderRadius:"4px",background:"#151b24"}})]})]},t))}),se&&e.jsx("div",{className:"projects-grid",children:E.map(t=>e.jsxs("div",{className:"project-card",onClick:()=>te(t),onContextMenu:a=>ae(a,t),children:[e.jsxs("div",{className:"project-thumb",children:[t.thumbnail&&!H.has(t.id)?e.jsx("img",{src:t.thumbnail,alt:t.name,style:{width:"100%",height:"100%",objectFit:"cover"},onError:()=>J(a=>new Set(a).add(t.id))}):e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",position:"absolute",inset:0,background:"linear-gradient(135deg, #111820, #0e1218)"},children:e.jsx(i,{i:"movie",s:32,c:"rgba(117,170,219,0.35)"})}),e.jsx("button",{className:"del-btn",onClick:a=>$(a,t.id),"aria-label":`Delete project ${t.name}`,title:"Delete project",children:e.jsx(i,{i:"delete",s:14,c:"white"})})]}),e.jsxs("div",{className:"project-info",children:[U===t.id?e.jsx("input",{autoFocus:!0,value:z,onChange:a=>F(a.target.value),onBlur:()=>W(t.id),onKeyDown:a=>{a.key==="Enter"&&W(t.id),a.key==="Escape"&&C(null)},onClick:a=>a.stopPropagation(),style:{background:"rgba(117,170,219,0.1)",border:"1px solid rgba(117,170,219,0.3)",borderRadius:"4px",padding:"2px 6px",color:"white",fontSize:"13px",fontWeight:600,fontFamily:"inherit",width:"100%",outline:"none"}}):e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"4px",minWidth:0},children:[e.jsx("p",{className:"name",onClick:a=>_(a,t),title:"Click to rename",style:{cursor:"text",flex:1,minWidth:0},children:t.name}),e.jsx("button",{onClick:a=>_(a,t),style:{background:"none",border:"none",cursor:"pointer",padding:"2px",opacity:.4,flexShrink:0,display:"flex",alignItems:"center"},title:"Rename","aria-label":`Rename ${t.name}`,children:e.jsx(i,{i:"edit",s:12,c:"rgba(255,255,255,0.5)"})})]}),e.jsxs("p",{className:"meta",children:[t.resolution," · ",ue(t.savedAt)]})]})]},t.id))}),b&&e.jsxs("div",{className:"ctx-menu",style:{left:b.x,top:b.y},children:[e.jsxs("button",{className:"ctx-menu-item",onClick:()=>{_({stopPropagation:()=>{}},b.project),S()},children:[e.jsx(i,{i:"edit",s:14})," Rename"]}),e.jsxs("button",{className:"ctx-menu-item",onClick:()=>ie(b.project),children:[e.jsx(i,{i:"content_copy",s:14})," Duplicate"]}),e.jsx("div",{className:"ctx-menu-sep"}),e.jsxs("button",{className:"ctx-menu-item ctx-menu-item--danger",onClick:t=>{$(t,b.project.id),S()},children:[e.jsx(i,{i:"delete",s:14})," Delete"]})]}),oe&&e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:e.jsx(i,{i:"movie_edit",s:26,c:"rgba(117,170,219,0.5)"})}),e.jsx("h3",{children:"Start your first project"}),e.jsx("p",{children:"Import a video, image, or audio file to create your first project and start editing."}),e.jsxs("div",{className:"empty-actions",children:[e.jsxs("button",{className:"empty-btn empty-btn--primary",onClick:D,children:[e.jsx(i,{i:"add",s:16,c:"#0a0a0a"}),"Import Media"]}),e.jsxs("button",{className:"empty-btn empty-btn--ghost",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:14}),"Long to Shorts"]})]}),e.jsx("p",{className:"empty-hint",children:"Supports MP4, WebM, MP3, WAV, PNG, JPG and more"})]})]}),!d&&!R&&e.jsxs("aside",{className:"advisor-panel",children:[e.jsxs("div",{className:"advisor-label-row",children:[e.jsxs("div",{className:"advisor-label",children:[e.jsx(i,{i:"assistant",s:14,c:"rgba(255,255,255,0.25)"}),"Advisor"]}),e.jsx("button",{type:"button",className:"advisor-dismiss",onClick:X,"aria-label":"Dismiss advisor panel",title:"Hide advisor",children:e.jsx(i,{i:"close",s:18})})]}),e.jsxs("div",{className:"advisor-item advisor-item--warning",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"shield",s:16,c:"#f59e0b"}),e.jsx("h4",{children:"Account Security"})]}),e.jsx("p",{children:"Strengthen your account by reviewing your security settings."}),e.jsxs("button",{className:"advisor-action advisor-action--warning",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#f59e0b"}),"Review Settings"]})]}),p.length===0&&!f?e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"rocket_launch",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Getting Started"})]}),e.jsxs("ul",{className:"advisor-checklist",children:[e.jsxs("li",{className:"done",children:[e.jsx(i,{i:"check_circle",s:14,fill:!0}),e.jsx("span",{children:"Create account"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Import your first media file"})]}),e.jsxs("li",{children:[e.jsx(i,{i:"radio_button_unchecked",s:14,c:"rgba(255,255,255,0.2)"}),e.jsx("span",{children:"Edit and export a project"})]})]})]}):p.length>0?e.jsxs("div",{className:"advisor-item advisor-item--success",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"check_circle",s:16,c:"#22c55e"}),e.jsx("h4",{children:"Workspace Active"})]}),e.jsxs("p",{children:[p.length," project",p.length!==1?"s":""," in your workspace. Last edited ",M(q),"."]})]}):null,e.jsxs("div",{className:"advisor-item advisor-item--info",children:[e.jsxs("div",{className:"advisor-item-header",children:[e.jsx(i,{i:"auto_awesome",s:16,c:"#75AADB"}),e.jsx("h4",{children:"Long to Shorts"})]}),e.jsx("p",{children:"Convert landscape videos to vertical format with AI-powered speaker tracking and smart reframing."}),e.jsxs("button",{className:"advisor-action advisor-action--info",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"arrow_forward",s:12,c:"#75AADB"}),"Try it"]})]})]})]})})]}),d&&e.jsxs("nav",{className:"mobile-bottom-nav",children:[e.jsxs("button",{className:h==="home"?"active":"",onClick:()=>v("home"),children:[e.jsx(i,{i:"home",s:22,fill:h==="home"}),e.jsx("span",{children:"Home"})]}),e.jsxs("button",{onClick:D,children:[e.jsx(i,{i:"add_circle",s:22,c:"#75AADB"}),e.jsx("span",{children:"New"})]}),e.jsxs("button",{className:h==="shorts"?"active":"",onClick:()=>r("/long-to-shorts"),children:[e.jsx(i,{i:"content_cut",s:22}),e.jsx("span",{children:"Reframe"})]}),e.jsxs("button",{className:h==="settings"?"active":"",onClick:()=>r("/settings"),children:[e.jsx(i,{i:"settings",s:22}),e.jsx("span",{children:"Settings"})]})]}),e.jsxs("div",{className:"bw-stripe",role:"presentation",children:[e.jsx("div",{style:{background:"#75AADB"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#000"}}),e.jsx("div",{style:{background:"white"}}),e.jsx("div",{style:{background:"#75AADB"}})]})]})};export{Se as default};
