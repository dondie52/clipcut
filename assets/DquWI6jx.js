import{u as p,r,j as e}from"./DwQPoapS.js";import{B as l}from"./D8AsaMNA.js";import{M as s}from"./DqMum2sp.js";import"./DZxFKcQQ.js";const c=`
...
`,g=()=>{const a=p(),[o,i]=r.useState(!1);return r.useEffect(()=>{const n="lp-landing-styles";if(!document.getElementById(n)){const t=document.createElement("style");t.id=n,t.textContent=c,document.head.appendChild(t)}return i(!0),()=>{const t=document.getElementById(n);t&&t.remove()}},[]),o?e.jsxs("div",{className:"lp-root",children:[e.jsxs("nav",{className:"lp-nav","aria-label":"Primary",children:[e.jsxs("span",{className:"lp-wordmark","aria-label":"ClipCut",children:["Clip",e.jsx("span",{className:"lp-wordmark-accent",children:"Cut"})]}),e.jsxs("div",{className:"lp-nav-right",children:[e.jsx("button",{type:"button",className:"lp-link-btn",onClick:()=>a("/login"),children:"Sign in"}),e.jsx("button",{type:"button",className:"lp-cta-primary",onClick:()=>a("/register"),children:"Get started"})]})]}),e.jsxs("main",{className:"lp-hero",children:[e.jsxs("span",{className:"lp-eyebrow",children:[e.jsx("span",{className:"lp-eyebrow-dot","aria-hidden":"true"}),"Open source · Made in Botswana"]}),e.jsxs("h1",{className:"lp-headline",children:["Edit videos in your browser.",e.jsx("span",{className:"lp-headline-secondary",children:"Built for Botswana creators."})]}),e.jsx("p",{className:"lp-subhead",children:"Open-source video editing with auto-captions, smart cuts, and cloud sync. No downloads. No watermarks."}),e.jsxs("div",{className:"lp-cta-row",children:[e.jsx("button",{type:"button",className:"lp-cta-hero",onClick:()=>a("/register"),children:"Get started free"}),e.jsx("span",{className:"lp-cta-microcopy",children:"No credit card. No subscription. Ever."})]})]}),e.jsx(l,{})]}):null};export{g as default};
